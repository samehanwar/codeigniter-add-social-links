...
<html lang="en">
    ...
    <body>
        ...
        <div class="container"> 
            <h1 style="text-align:center;font-weight: bold;"> Add A Social Platform Plugin </h1>
          ...
          <div class="row table-social"> 
            <div class="col-md-12">
              <div class="table-responsive"> 
                  <?php echo form_open('social/add_platform'); ?>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
            ...
            $('#add_field').on('click',function(){
                ...
                output += '<td> <button class="btn btn-danger delete_field" type="button"><i class="fa fa-times"> </i> </button> </td>';
                output += '</tr>';
...
//                var arr = ['whatsapp' , 'skype' , 'vimeo'] ;
        ...
        // delete a social platform field from the list  
          ...
          $('.table-social').on('click','.delete_field',function(e){
              e.preventDefault();
              var id = $(this).data('id'),
                  current_url =  window.location.href ;
              $.ajax({
                  url:'<?php echo base_url(); ?>social/delete_field',
                  data: {id : id},
                  type:'POST',
